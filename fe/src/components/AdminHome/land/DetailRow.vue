...
<template>
	<tr class="bg-gray-50">
		<td colspan="7" class="p-4 border-t border-gray-300">
			<div class="grid grid-cols-2 gap-x-6 gap-y-4">
				<div class="flex items-center col-span-2">
					<span class="font-bold text-gray-700 w-32">제목</span>
				...
				<div class="flex items-center">
					<span class="font-bold text-gray-700 w-32">면적/평</span>
					<span class="text-gray-900">20평</span>
				</div>
				<div class="flex items-center">
					<span class="font-bold text-gray-700 w-32">가격/일</span>
					<span class="text-gray-900">{{ row.price }}</span>
				</div>
				<div class="flex items-center">
